#!/usr/bin/env python3
"""Uploads graphtr-out/knowledge/*.md into hoton-rag's document RAG under a
...
re-uploading. Run via: python3 hoton-rag/scripts/index_knowledge.py

Note: hoton-rag's /api/documents upload derives `title` from the uploaded
